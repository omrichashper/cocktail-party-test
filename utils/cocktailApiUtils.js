...
const retreiveAllMenuInfo = (menuId, userId) => __awaiter(void 0, void 0, void 0, function* () {
    const menuResult = yield psqlConnection_1.default.query(`SELECT m.id, m.image_id, m.title, (SELECT count(*) FROM menu_items mi WHERE mi.menu_id = m.id) as item_count
         FROM menus m
