...
cocktailApiRouter.get('/my_menus', authUtils_1.verifyToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    if (!req.userId)
        return res.sendStatus(401);
    return psqlConnection_1.default.query(`SELECT m.id, m.title, m.image_id, (SELECT count(*) FROM menu_items mi WHERE mi.menu_id = m.id) as item_count
         FROM menus m
         WHERE m.user_id = $1`, [req.userId]).then((result) => __awaiter(void 0, void 0, void 0, function* () {
